...
Study materials are organized into subject-grouped sections on the Materials Library page, with alphabetical sorting and visual hierarchy, while preserving search and filter capabilities. Students can view materials directly within the application using an in-app viewer (iframe-based) or download them for offline access. The viewer displays material metadata including upload date, filename, subject, and material type classification.
